 ...
 *   Название: Покупка первого товара. Карта МИР
 */
...
public class buyFirstItem {
    ...
    public void test() throws Exception {
        ...
        //  Тапаем на кнопку details, элемента листВью на 1 позиции
        onData(anything())
                .inAdapterView(withId(R.id.lv_books))
                .atPosition(0)
                .onChildView(withId(R.id.tv_book_details)) // кнопка details
                .perform(click()); // кликаем
        ...
        // Вводим PAN номер карты (замечено: используется кастомная клавиатура, со своим классом)
        ...
        Thread.sleep(2000); // ждем пока появится поле с CVV карты
